...
function setupTestApp() {
    ...
    mockStorage.saveReminder.mockImplementation(async (r) => ({
        ...r,
        id: 'test-reminder-id',
        created_at: new Date(),
        active: true,
    ...
    mockStorage.getReminderForUser.mockImplementation(async (id, userId) => ({
        id,
        userId,
        text: 'Test Reminder',
        scheduleType: 'once',
...
describe('Reminder Flow Integration', () => {
    ...
    it('should schedule a one-time reminder', async () => {
        ...
        expect(mockBus.emit).toHaveBeenCalledWith('telegram.sendMessage', expect.objectContaining({
            chatId: 'chat-123',
