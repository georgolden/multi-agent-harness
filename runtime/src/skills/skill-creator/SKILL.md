...
Skills are modular, self-contained packages that extend AI Agent's capabilities by providing
specialized knowledge, workflows, and tools. Think of them as "onboarding guides" for specific
domains or tasks—they transform AI Agent from a general-purpose agent into a specialized agent
